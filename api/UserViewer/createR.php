...
if ($jwt) {
    ...
    try {
        ...
        if ($jwt->isValid() && $dE) {
            ...
            switch ($ric->tipoRic){
                case 'G1':
                    $ric->G1_num_GG = $dE->hNum_GG;
                    break;
                case 'G2':
                    // nulla da fare...
                    break;
                case 'S1':
                    $ric->S1_gg_SETT = $dE->hS1_gg_SETT;
                    $ric->S1_num_SETT = $dE->hNum_SETT;
                    break;
                case 'M1':
                    $ric->M1_num_MESI= $dE->hNum_MESI;
                    $ric->M1_num_GG=$dE->hNum_GG;
                    break;
                case 'M2':
                    $ric->M2_num_MESI= $dE->hNum_MESI;
                    $ric->M2_gg_SETT=$dE->hGg_SETT;
                    $ric->M2_gg_ORD = $dE->hGg_ORD;
                    break;
                case 'A1':
                    $ric->A_num_ANNO = $dE->hNum_ANNO;
                    $ric->A1_mese = $dE->hMese;
                    $ric->A1_gg = $dE->hGg;
                    break;
                case'A2':
                    $ric->A_num_ANNO = $dE->hNum_ANNO;
                    $ric->A2_gg_ORD =$dE->hGg_ORD;
                    $ric->A2_gg_SETT =$dE->hGg_SETT;
                    $ric->A2_MESE =$dE->hMese;
                    break;
            }
